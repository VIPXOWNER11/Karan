...
FORWARD_CHANNEL_ID = -1002471240232
CHANNEL_ID = -1002471240232
error_channel_id = -1002471240232
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="♻️ 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ♻️", url="https://t.me/+HtD5jKa0l7lhMGZl")
    button1 = types.InlineKeyboardButton(text="☣️ 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 ☣️",
        url="https://t.me/VIP_OWNER9")
    markup.add(button3)
    markup.add(button1)
    return markup
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/+HtD5jKa0l7lhMGZl")
            markup.add(button1)
            markup.add(button2)
        else:
            ...
            button = types.InlineKeyboardButton(
                text="💢 𝐉𝐎𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 💢", url="https://t.me/+HtD5jKa0l7lhMGZl")
            markup.add(button)
...
def canary_command(message):
    ...
    button1 = types.InlineKeyboardButton(
        ...
        url="https://t.me/c/2520332135/805")
    button2 = types.InlineKeyboardButton(
